...
//        exist();
    ...
    public static void createNode() throws KeeperException, InterruptedException {
        String s = zooKeeper.create("/di1shuai", "zs".getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
        System.out.println(s);
    }

    //判断节点是否存在
    public static void exist() throws KeeperException, InterruptedException {
        Stat stat = zooKeeper.exists("/di1shuai", false);
