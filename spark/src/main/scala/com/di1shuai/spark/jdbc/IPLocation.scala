package com.di1shuai.spark.jdbc
...
object IPLocation {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val ipRulesRdd = sc.textFile("C:\\Users\\Administrator\\IdeaProjects\\bigdata\\spark\\src\\main\\resources\\ip.txt")
      .map(line => {
    ...
    //  3 加载访问记录到内存
    val ipsRDD = sc.textFile("C:\\Users\\Administrator\\IdeaProjects\\bigdata\\spark\\src\\main\\resources\\20090121000132.394251.http.format")
      .map(line => {
